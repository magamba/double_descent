...
resnet18_increasing_widths = {
    "resnet18_" + str(width): partial(ResNetBuilder, ResNetNoBNSmall, BasicBlock, [2, 2, 2, 2], inplanes=width, channels=(2*width, 4*width, 8*width)) for width in list(range(1,65)) + [128, 256, 512]
}
