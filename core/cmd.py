...
def add_default_opts(parser):
    ...
    parser.add_argument(
        "--crop-flipped-only",
        action="store_true",
        help="Apply random cropping augmentation only after horizontally flipping a sample. Requires AUGMENTATION to be set.",
    )
    parser.add_argument(
        "--label-noise",
        default=0.,
    ...
    parser.add_argument(
        ...
        default="symmetric",
        type=str,
        help="symmetric vs asymmetric label noise.",
    )
    parser.add_argument(
